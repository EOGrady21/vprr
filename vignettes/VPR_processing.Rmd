...
The goal of this section of VPR processing is to combine the VPR CTD output with the classified ROI data from VP to produce an estimate of concentrations of classified groups, associated with CTD data, in vertical bins along the VPR tow-yo path.

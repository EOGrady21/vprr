...
```{r}
vpr_metadata_template <- "extdata/vpr_metadata_template.xlsx"
...
```{r}
data <- read.csv("extdata/vpr123_station25.csv")
head(data)

metadata <- rjson::fromJSON(file = "extdata/vpr123_station25-metadata.json")
```

# Contributor Covenant Code of Conduct for the [`vprr`] project

([Français](#Code-de-conduite-pour-le-projet-nom-du-projet))

Contributors to repositories hosted in [`vprr`] are expected to follow the Contributor Covenant Code of Conduct, and those working within Government are also expected to follow the Values and Ethics Code for the Public Sector
...
This Code of Conduct applies both within project spaces and in public spaces when an individual is representing the project, members or Department of Fisheries and Oceans (DFO).
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported by contacting the project team at vprrcontact@gmail.com.
...
Les contributeurs aux dépôts hébergés dans [`vprr`] sont tenus de respecter le Code de conduite du Pacte des contributeurs, et ceux qui travaillent au sein du gouvernement sont également tenus de respecter le Code de valeurs et d'éthique du secteur public.
...
Les cas de comportement abusif, de harcèlement ou d'autres comportements inacceptables peuvent être rapportés en communiquant avec l'équipe de projet à l'adresse suivante : vprrcontact@gmail.com.
